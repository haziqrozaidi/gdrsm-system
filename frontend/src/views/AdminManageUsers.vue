                ...
                <div v-else>
                    <DataTable :value="users" :loading="loading" stripedRows>
                        ...
                        <Column header="Actions">
                            <template #body="{ data }">
                                <Button v-if="data.role === 'Pensyarah' || data.role === 'admin'" icon="pi pi-user-edit"
                                    label="Change Role" outlined class="mr-2" @click="openChangeRoleDialog(data)" />
                                <Button icon="pi pi-trash" label="Delete User" outlined class="mr-2"
                    ...
                    <Dialog v-model:visible="showChangeRoleDialog" header="Confirm Role Change"
                        ...
                        <template #footer>
                            <div class="flex justify-end space-x-3">
                                <Button label="Cancel" icon="pi pi-times" @click="showChangeRoleDialog = false"
                                    class="p-button-outlined p-button-secondary" />
                                <Button label="Confirm" icon="pi pi-check" @click="confirmRoleChange"
                    ...
                    <Dialog v-model:visible="showDeleteUserDialog" header="Confirm User Deletion"
                        :style="{ width: '30rem' }" modal>
                        <div class="flex flex-col space-y-4">
                            <p class="text-gray-700">
                        ...
                        <template #footer>
                            <div class="flex justify-end space-x-3">
                                <Button label="Cancel" icon="pi pi-times" @click="showDeleteUserDialog = false"
                                    class="p-button-outlined p-button-secondary" />
                                <Button label="Confirm" icon="pi pi-check" @click="confirmDeleteUser"
